                ...
                {pred.locked ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full bg-slate-700 hover:bg-emerald-600 disabled:opacity-50 disabled:hover:bg-slate-700 text-white font-bold py-3 rounded-lg transition-all active:scale-[0.98]"
                    >
