            ...
            <div key={p.id} className="glass-card p-4 md:p-5 hover:border-slate-500/50 transition-colors">
              ...
              <div className="flex justify-end border-t border-slate-800/50 pt-3">
                <button
                  ...
                  className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-300 px-4 py-1.5 rounded-full text-sm font-medium transition-all active:scale-95 shadow-sm"
                >
