    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 max-w-lg w-full shadow-2xl relative animate-in fade-in zoom-in duration-200">
            <button 
            ...
            <h2 className="text-2xl font-black text-white mb-6 flex items-center gap-2">
              <Trophy className="text-yellow-400" /> PitchSense Rules
            </h2>
